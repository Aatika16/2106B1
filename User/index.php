...
$q="select * from trainers order by id desc limit 3";
    ...
    <div class="row">
      <div class="col-12">
        <div class="d-flex align-items-center section-title justify-content-between">
          <h2 class="mb-0 text-nowrap mr-3">Our Trainers</h2>
          <div class="border-top w-100 border-primary d-none d-sm-block"></div>
          <div>
            <a href="trainers.php" class="btn btn-sm btn-outline-primary ml-sm-3 d-none d-sm-block">see all</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        <ul class="list-inline mb-2">
          ...
          <li class="list-inline-item"><a class="text-color" href="course-single.html">Experoiace</a></li>
        </ul>
        <a href="course-single.html">
          <h4 class="card-title"><?php  echo $data['Trainer_name'] ?></h4>
        </a>
       
        <a href="trainer-single.php?id=<?php echo $data['id'] ?>" class="btn btn-primary btn-sm">Deatils</a>
      </div>
    </div>
  </div>
<?php } ?>
