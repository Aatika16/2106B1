    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb mb-2">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="courses.html">Our Trainers</a></li>
          <li class="list-inline-item text-white h3 font-secondary nasted"><?php echo $data['Trainer_name'] ?></li>
        </ul>
  ...
  <div class="container">
    ...
    <div class="row align-items-center mb-5">
      ...
      <div class="col-xl-3 text-sm-right text-left order-sm-2 order-3 order-xl-3 col-sm-6 mb-4 mb-xl-0">
        <a href="packages.php?tr_id=<?php echo $data['id']?>" class="btn btn-primary">Apply now</a>
      </div>
      <!-- border -->
