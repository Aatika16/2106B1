        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item @@courses">
              <a class="nav-link" href="courses.php">traines</a>
            </li>
            <li class="nav-item @@events">
              <a class="nav-link" href="events.html">equipemts</a>
            </li>
            <li class="nav-item @@events">
...
<?php while($data=mysqli_fetch_assoc($run)) { ?>
                <li><a class="dropdown-item" href="packages.php?cat_id=<?php echo $data['id']?>"><?php echo $data['cat_name']?></a></li>
